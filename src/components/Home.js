        ...
        <div className="row min-vh-100 align-items-center">
          <div className="col-lg-6 pe-xl-5 py-5">
            <div className="home-intro one-page-nav">
              ...
              <p>
                I design and develop responsive and modern user interfaces for
                clients of all sizes. My focus is on creating fast, visually
                appealing, and user-friendly websites and web applications using
